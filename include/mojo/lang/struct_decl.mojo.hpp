...
MOJO_BUILD_STRUCT_TYPE(mojo, lang, StructDecl) {
    ...
    field(&mojo::lang::StructDecl::enclosingDecl, "enclosing_decl", "enclosingDecl", 1);
    field(&mojo::lang::StructDecl::typeAliasDecls, "type_alias_decls", "typeAliasDecls", 1);
    field(&mojo::lang::StructDecl::structDecls, "struct_decls", "structDecls", 1);
    field(&mojo::lang::StructDecl::enumDecls, "enum_decls", "enumDecls", 1);
}
